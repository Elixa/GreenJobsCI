...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es-ES">
	<head>
		...
		<link rel="stylesheet" href="<?=$this->config->item("template")?>style/web/css/webStyle.css" type="text/css">	
		<link rel="stylesheet" href="<?=$this->config->item("template")?>style/web/css/stylesheet.css" type="text/css">	
